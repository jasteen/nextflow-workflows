...
ch_bamIN = Channel.fromFilePairs("./bams/*.{bam,bam.bai}", flat: true)
...
process run_vardict {
    ...
    VarDict --nosv -k 0 -q 15 -G ${ref} -f ${af_thr} -N "${baseName}" -b ${bam} -c 1 -S 2 -E 3 -g 4 ${intervalFile} > "${baseName}.tsv"
    """
}
