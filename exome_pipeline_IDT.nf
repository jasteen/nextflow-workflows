...
padded_int     = file('/projects/vh83/reference/IDT_exome_panel/xgenV2xgen-exome-research-panel-v2-targets-hg1902a5791532796e2eaa53ff00001c1b3c.padded.bed.interval_list')
...
process groupreadsByUmi {
    ...
    java -Xmx${task.memory.toGiga() - 2}g -Djava.io.tmpdir=$tmp_dir -jar $fgbioJar GroupReadsByUmi \
         -i ${bam} -f "${baseName}.piped.grouped.histogram.tsv" -o "${baseName}.piped.grouped.bam" -s paired -e 0 --min-map-q=20 
    """
