...
chip_library_path = file("/projects/vh83/reference/axiom/r3/")
...
process runDQC {
    ...
    --xml-file ${chip_library_path}/Axiom_ABC.r3.apt-geno-qc.AxiomQC1.xml \
    --cel-files cel.txt \
...
process runGTQC {
    ...
    --arg-file  ${chip_library_path}/Axiom_ABC_96orMore_Step1.r3.apt-genotype-axiom.AxiomGT1.apt2.xml \
